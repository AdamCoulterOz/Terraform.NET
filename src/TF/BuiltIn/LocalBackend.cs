...
///     locally.
/// </summary>
public class LocalBackend(FileInfo? stateFile = null, DirectoryInfo? workspace = null) : Backend
{
    ...
    /// </summary>
    [Terraform("path")]
    public FileInfo? StateFile { get; } = stateFile;

    /// <summary>
    ///     The path to non-default workspaces.
    /// </summary>
    [Terraform("workspace_dir")]
    public DirectoryInfo? Workspace { get; } = workspace;
}
