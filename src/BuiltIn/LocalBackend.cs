...
public class LocalBackend : Backend<VoidCredential>
{
	...
	/// <summary>The path to the tfstate file. This defaults to "terraform.tfstate" relative to the root module by default.</summary>
	[CliNamed("path")]
	public FileInfo? StateFile { get; init; }

	/// <summary>The path to non-default workspaces.</summary>
