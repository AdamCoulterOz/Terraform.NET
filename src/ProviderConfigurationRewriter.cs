...
internal static class ProviderConfigurationRewriter
{
	...
	private sealed class HclBodyParser
	{
		...
		private JsonNode ParseInlineObject()
		{
			Expect('{');
		...
		private JsonNode ParseScalarOrExpression()
		{
		...
		private void AddBlock(JsonObject body, string key, IReadOnlyList<string> labels, JsonObject blockBody)
		{
			JsonNode node = blockBody;
